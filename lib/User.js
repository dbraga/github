...
class User extends Requestable {
   ...
   /**
    * List public events performed by user
    ...
    */
   listEventsPublic(cb) {
      return this._request('GET', this.__getScopedUrl('events/public'), null, cb);
   }
    ...
    */
   listEvents(cb) {
      return this._request('GET', this.__getScopedUrl('events'), null, cb);
   }
